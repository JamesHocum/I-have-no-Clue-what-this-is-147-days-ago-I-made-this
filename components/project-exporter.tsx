      ...
      <CardContent>
        <Tabs value={exportType} onValueChange={setExportType} className="w-full">
          <TabsList className="grid w-full grid-cols-3">
            ...
            <TabsTrigger value="electron">💻 Desktop</TabsTrigger>
            <TabsTrigger value="capacitor">🤖 Mobile</TabsTrigger>
          </TabsList>
          ...
          <TabsContent value="pwa" className="space-y-4">
            ...
            <div className="text-xs text-muted-foreground space-y-1">
              <div>✓ Service Worker for offline functionality</div>
              <div>✓ Web App Manifest for installation</div>
          ...
          <TabsContent value="electron" className="space-y-4">
            <div className="space-y-4">
              ...
              <div className="text-xs text-muted-foreground space-y-1">
                <div>✓ Windows, macOS, Linux support</div>
                <div>✓ Native system integration</div>
                <div>✓ Auto-updater support</div>
                <div>✓ System tray integration</div>
                <div>✓ File system access</div>
              </div>
            </div>
          </TabsContent>
          ...
          <TabsContent value="capacitor" className="space-y-4">
            <div className="space-y-4">
              ...
              <div className="text-xs text-muted-foreground space-y-1">
                <div>✓ Native iOS and Android apps</div>
                <div>✓ Access to device APIs</div>
                <div>✓ App store distribution ready</div>
                <div>✓ Push notifications</div>
                <div>✓ Camera and file access</div>
              </div>
            </div>
          </TabsContent>
        </Tabs>
